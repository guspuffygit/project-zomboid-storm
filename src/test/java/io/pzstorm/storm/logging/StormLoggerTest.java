...
class StormLoggerTest implements UnitTest {
    ...
    void shouldSetStormLoggerLevelFromSystemProperties() throws ReflectiveOperationException {
        ...
        //        Level originalLevel =
        //                Level.toLevel(System.getProperty(StormLogger.LOGGER_PROPERTY, "INFO"));
        //
        ...
        //
        //            AppenderControlArraySet appenders =
        //                    (AppenderControlArraySet) appendersField.get(rootLoggerConfig);
        ...
        //                    actualLevels.put(appenderName, (Level)
        // appenderLevelField.get(appenderControl));
        //                }
        //            }
        ...
        //            rootLoggerConfig.addAppender(config.getAppender("StormConsole"),
        // originalLevel, null);
        //
        //            ctx.updateLoggers();
        //        }
