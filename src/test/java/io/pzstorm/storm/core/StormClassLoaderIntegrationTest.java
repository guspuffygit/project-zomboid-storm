...
class StormClassLoaderIntegrationTest extends StormClassLoader implements IntegrationTest {
    ...
    private static final URL CLASSES_RESOURCE_DIR =
            Objects.requireNonNull(CL.getResource("./classes/"));
    private static final URL DELEGATE_RESOURCE_DIR =
            Objects.requireNonNull(CL.getResource("./delegate/"));
    ...
    void shouldLoadNonBlacklistedClassesWithStormClassLoader() throws ReflectiveOperationException {
        ...
        ImmutableSet<String> dummyGameClasses =
                ImmutableSet.of(
                        "fmod.FmodClass",
                        "jassimp.JassimpLibraryClass",
                        "javax.vecmath.MathClass",
                        "org.lwjgl.LwjglLibraryClass",
                        "zombie.ZombieClass");
    ...
    @Test
    void shouldDelegateLoadingBlacklistedClassesToParentClassLoader()
            throws ReflectiveOperationException {
        ImmutableSet<String> dummyClasses =
                ImmutableSet.of(
    ...
    void whenIncorrectPackageNameShouldNotDefinePackage() {
        String[] incorrectPackageNames = new String[] {"package", ".package", ".", ""};
    ...
    void shouldDefinePackageWhenPackageNameIsValid() {
        Map<String, String> validPackageNames =
                ImmutableMap.of(
                        "valid.package", "valid",
        ...
        for (Map.Entry<String, String> entry : validPackageNames.entrySet()) {
            ...
            Assertions.assertEquals(
                    entry.getValue(), Objects.requireNonNull(resultPackage).getName());
        }
    }
