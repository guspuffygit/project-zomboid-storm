...
class StormModRegistryIntegrationTest extends ModLoaderTestFixture {
    ...
    private static final File TEMP_DIR =
            IntegrationTest.getTemporaryBuildDir(StormModRegistryIntegrationTest.class);
    ...
    static {
        try {
            STORM_MOD_LOADER_CLASS =
                    Class.forName(
                            "io.pzstorm.storm.core.StormModLoader",
                            true,
                            StormBootstrap.CLASS_LOADER);
            STORM_MOD_REGISTRY_CLASS =
                    Class.forName(
            ...
            GET_REGISTERED_MOD =
                    STORM_MOD_REGISTRY_CLASS.getDeclaredMethod("getRegisteredMod", String.class);
