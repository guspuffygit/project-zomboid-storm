...
class StormClassTransformerIntegrationTest implements IntegrationTest {
    ...
    private static void createAndRegisterTransformer(String className, String sTransformerClass)
            throws ReflectiveOperationException {
        Class<?> transformerClass =
                Class.forName(sTransformerClass, true, StormBootstrap.CLASS_LOADER);
    ...
    void shouldInsertInstructionBeforeMatchedLabel() throws ReflectiveOperationException {
        ...
        zombieUtils
                .getDeclaredMethod("setZombieProperties", int.class, boolean.class)
                .invoke(null, 21, true);
