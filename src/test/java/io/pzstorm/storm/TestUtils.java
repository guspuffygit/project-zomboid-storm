...
public class TestUtils {
    ...
    /**
     * Invokes the given inaccessible {@code Method} without leaving method accessible. After the
     * method was invoked the {@code accessible} flag will be set to it's original state.
     *
