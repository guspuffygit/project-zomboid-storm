...
class LuaEventFactoryTest implements UnitTest {
    ...
    private static final ImmutableMap<Class<? extends LuaEvent>, Class<?>[]>
            EVENT_CLASS_CONSTRUCTOR_DATA =
                    ImmutableMap.<Class<? extends LuaEvent>, Class<?>[]>builder()
                            .put(OnChallengeQueryEvent.class, new Class<?>[] {})
                            .put(
                                    OnCharacterCollideEvent.class,
                                    new Class<?>[] {IsoMovingObject.class, IsoObject.class})
                            .put(
                                    OnCreateLivingCharacterEvent.class,
                                    new Class<?>[] {IsoPlayer.class, SurvivorDesc.class})
                            .put(OnFETickEvent.class, new Class<?>[] {Integer.class})
                            .put(
                            ...
                            .put(OnJoypadActivateEvent.class, new Class<?>[] {Integer.class})
                            .put(OnKeyPressedEvent.class, new Class<?>[] {Integer.class})
                            .put(OnKeyStartPressedEvent.class, new Class<?>[] {Integer.class})
                            ...
                            .put(
                                    ...
                                    new Class<?>[] {IsoMovingObject.class, IsoObject.class})
                            .put(OnPlayerUpdateEvent.class, new Class<?>[] {IsoPlayer.class})
                            ...
                            .put(
                                    ...
                                    new Class<?>[] {KahluaTable.class, String.class})
                            .put(OnTickEvenPausedEvent.class, new Class<?>[] {Double.class})
                            .put(OnTickEvent.class, new Class<?>[] {Double.class})
                            .put(
                            ...
                            .put(
                                    ...
                                    new Class<?>[] {IsoGameCharacter.class, HandWeapon.class})
                            .put(OnZombieUpdateEvent.class, new Class<?>[] {IsoZombie.class})
                            .build();

    @Test
    void shouldConstructLuaEventFromClassInstance() {
        for (Map.Entry<Class<? extends LuaEvent>, Class<?>[]> entry :
                EVENT_CLASS_CONSTRUCTOR_DATA.entrySet()) {
            Class<? extends LuaEvent> eventClass = entry.getKey();
            List<Object> constructorArgs = getDummyConstructorArgList(entry.getValue());

            LuaEvent event =
                    LuaEventFactory.constructLuaEvent(eventClass, constructorArgs.toArray());
    ...
    void shouldConstructLuaEventFromClassName() {
        for (Map.Entry<Class<? extends LuaEvent>, Class<?>[]> entry :
            ...
            LuaEvent event =
                    LuaEventFactory.constructLuaEvent(eventName, constructorArgs.toArray());
            Assertions.assertTrue(
                    eventClass.isAssignableFrom(Objects.requireNonNull(event).getClass()));
        }
    }
    ...
    void shouldGetNullLuaEventWithNonExistingClassName() {
        ...
        Assertions.assertNull(
                LuaEventFactory.constructLuaEvent(eventName, new ArrayList<>().toArray()));
    }
