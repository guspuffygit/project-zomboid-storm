 ...
 * {@code -Dstorm.cells.keepWarm=true} the warm advice body-replaces postupdate before this advice
 * runs, and the budget helper's {@code StormCellWarmingConfig} gate keeps the two body replacements
 * mutually exclusive regardless of ordering.
 */
