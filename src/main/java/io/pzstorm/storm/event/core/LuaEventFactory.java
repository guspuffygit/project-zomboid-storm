...
/**
 * This class is used to creates new {@link LuaEvent} instances on demand. The factory uses
 * reflection to invoke the event class constructor to instantiate events. Note that class and
...
public class LuaEventFactory {
     ...
     * mapped in this way to increase performance when instantiating {@code LuaEvent}s.
     */
    ...
    static {
         ...
         */
        Class<? extends LuaEvent>[] eventClasses =
                (Class<? extends LuaEvent>[])
                        new Class[] {
     ...
     * @throws IllegalArgumentException if no constructor with parameters matching specified array
     *     of arguments was found for given {@code LuaEvent} class, an error occurred while
    ...
    public static LuaEvent constructLuaEvent(Class<? extends LuaEvent> eventClass, Object... args) {
        ...
        if (constructors != null) {
            ...
            throw new IllegalArgumentException(
                    String.format(message, eventClass, Arrays.toString(args)));
        }
        throw new IllegalStateException(
                "No registered constructors found for event '" + eventClass + '\'');
    }
     ...
     *     occurred while instantiating {@code LuaEvent} or no registered constructors found for
     *     event class resolved from given name.
     */
