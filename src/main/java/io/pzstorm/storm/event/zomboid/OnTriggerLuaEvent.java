...
/**
 * This event fires when an in-game Lua event has been triggered. This event is only used internally
 * to catch <i>most</i> triggered Lua events, after which they are used to dispatched {@link
 * LuaEvent} instances. For performance and usability reasons it is recommended to subscribe to
 * specific {@link LuaEvent LuaEvents} rather then this event.
 */
