...
public final class ChunkLoadMetrics {
    ...
    static {
        Thread reporter = new Thread(ChunkLoadMetrics::reporterLoop, "StormChunkLoadMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("ChunkLoadMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "ChunkLoadMetrics: window={}ms ticks=0 calls=0 (no activity)", windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "ChunkLoadMetrics: window={}ms ticks={} calls={} totalMs={} avgPerTickMs={}"
