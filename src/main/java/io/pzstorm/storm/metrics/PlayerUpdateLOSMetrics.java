...
public final class PlayerUpdateLOSMetrics {
    ...
    static {
        Thread reporter =
                new Thread(PlayerUpdateLOSMetrics::reporterLoop, "StormPlayerUpdateLOSMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("PlayerUpdateLOSMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "PlayerUpdateLOSMetrics: window={}ms ticks=0 calls=0 (no activity)", windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "PlayerUpdateLOSMetrics: window={}ms ticks={} calls={} totalMs={} avgPerTickMs={}"
