...
public final class EntityManagerUpdateMetrics {
    ...
    static {
        Thread reporter =
                new Thread(
                        EntityManagerUpdateMetrics::reporterLoop,
                        "StormEntityManagerUpdateMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("EntityManagerUpdateMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "EntityManagerUpdateMetrics: window={}ms ticks=0 calls=0 (no activity)",
                    windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "EntityManagerUpdateMetrics: window={}ms ticks={} calls={} totalMs={}"
