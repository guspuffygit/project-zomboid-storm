...
public final class ServerLOSUpdateMetrics {
    ...
    static {
        Thread reporter =
                new Thread(ServerLOSUpdateMetrics::reporterLoop, "StormServerLOSUpdateMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("ServerLOSUpdateMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "ServerLOSUpdateMetrics: window={}ms ticks=0 calls=0 (no activity)", windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "ServerLOSUpdateMetrics: window={}ms ticks={} calls={} totalMs={} avgPerTickMs={}"
