...
public final class AnimalUpdateLOSMetrics {
    ...
    static {
        Thread reporter =
                new Thread(AnimalUpdateLOSMetrics::reporterLoop, "StormAnimalUpdateLOSMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("AnimalUpdateLOSMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "AnimalUpdateLOSMetrics: window={}ms ticks=0 calls=0 (no activity)", windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "AnimalUpdateLOSMetrics: window={}ms ticks={} calls={} totalMs={} avgPerTickMs={}"
