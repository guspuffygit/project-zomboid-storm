...
public final class BaseVehicleUpdateMetrics {
    ...
    static {
        Thread reporter =
                new Thread(BaseVehicleUpdateMetrics::reporterLoop, "StormBaseVehicleUpdateMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("BaseVehicleUpdateMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "BaseVehicleUpdateMetrics: window={}ms ticks=0 calls=0 (no activity)",
                    windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "BaseVehicleUpdateMetrics: window={}ms ticks={} calls={} totalMs={}"
