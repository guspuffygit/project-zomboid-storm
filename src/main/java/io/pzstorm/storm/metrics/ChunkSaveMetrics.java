...
public final class ChunkSaveMetrics {
    ...
    static {
        Thread reporter = new Thread(ChunkSaveMetrics::reporterLoop, "StormChunkSaveMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("ChunkSaveMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "ChunkSaveMetrics: window={}ms ticks=0 calls=0 (no activity)", windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "ChunkSaveMetrics: window={}ms ticks={} calls={} totalMs={} avgPerTickMs={}"
