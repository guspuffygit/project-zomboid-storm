...
public final class ObjectRemoveFromWorldMetrics {
    ...
    static {
        Thread reporter =
                new Thread(
                        ObjectRemoveFromWorldMetrics::reporterLoop,
                        "StormObjectRemoveFromWorldMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("ObjectRemoveFromWorldMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "ObjectRemoveFromWorldMetrics: window={}ms ticks=0 calls=0 (no activity)",
                    windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "ObjectRemoveFromWorldMetrics: window={}ms ticks={} calls={} totalMs={}"
