...
public final class ZombieSpotPlayerMetrics {
    ...
    static {
        Thread reporter =
                new Thread(ZombieSpotPlayerMetrics::reporterLoop, "StormZombieSpotPlayerMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("ZombieSpotPlayerMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "ZombieSpotPlayerMetrics: window={}ms ticks=0 calls=0 (no activity)", windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "ZombieSpotPlayerMetrics: window={}ms ticks={} calls={} totalMs={} avgPerTickMs={}"
