...
public final class UsingPlayerUpdateMetrics {
    ...
    static {
        Thread reporter =
                new Thread(UsingPlayerUpdateMetrics::reporterLoop, "StormUsingPlayerUpdateMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("UsingPlayerUpdateMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "UsingPlayerUpdateMetrics: window={}ms ticks=0 calls=0 (no activity)",
                    windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "UsingPlayerUpdateMetrics: window={}ms ticks={} calls={} totalMs={} avgPerTickMs={}"
