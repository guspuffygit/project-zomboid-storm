...
public final class VehicleServerUpdateMetrics {
    ...
    static {
        Thread reporter =
                new Thread(
                        VehicleServerUpdateMetrics::reporterLoop,
                        "StormVehicleServerUpdateMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("VehicleServerUpdateMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "VehicleServerUpdateMetrics: window={}ms ticks=0 calls=0 (no activity)",
                    windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "VehicleServerUpdateMetrics: window={}ms ticks={} calls={} totalMs={}"
