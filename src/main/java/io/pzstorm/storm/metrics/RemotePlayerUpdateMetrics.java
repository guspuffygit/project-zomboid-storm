...
public final class RemotePlayerUpdateMetrics {
    ...
    static {
        Thread reporter =
                new Thread(
                        RemotePlayerUpdateMetrics::reporterLoop, "StormRemotePlayerUpdateMetrics");
    ...
    private static void reporterLoop() {
        while (true) {
            ...
            try {
                ...
                StormLogger.LOGGER.warn("RemotePlayerUpdateMetrics reporter failed", t);
            }
        }
    }
    ...
    private static void report() {
        ...
        if (ticks == 0L && calls == 0L) {
            StormLogger.LOGGER.info(
                    "RemotePlayerUpdateMetrics: window={}ms ticks=0 calls=0 (no activity)",
                    windowMs);
            return;
        }
        ...
        StormLogger.LOGGER.info(
                "RemotePlayerUpdateMetrics: window={}ms ticks={} calls={} totalMs={}"
