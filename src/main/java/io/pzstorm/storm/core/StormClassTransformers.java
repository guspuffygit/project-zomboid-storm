...
import io.pzstorm.storm.patch.performance.InventoryItemUpdateDirtyPatch;
...
import io.pzstorm.storm.patch.performance.IsoChunkDirtyTrackerPatch;
import io.pzstorm.storm.patch.performance.IsoChunkInvalidateCachePatch;
...
import io.pzstorm.storm.patch.performance.IsoChunkSaveCacheHitPatch;
...
import io.pzstorm.storm.patch.performance.IsoGridSquareChunkDirtyPatch;
import io.pzstorm.storm.patch.performance.IsoGridSquareRemoveBloodDirtyPatch;
import io.pzstorm.storm.patch.performance.IsoObjectChunkDirtyPatch;
...
public class StormClassTransformers {
    ...
    static {
        ...
        registerTransformer(new IsoChunkSaveCacheHitPatch());
        registerTransformer(new IsoChunkInvalidateCachePatch());
        registerTransformer(new IsoChunkDirtyTrackerPatch());
        registerTransformer(new IsoGridSquareRemoveBloodDirtyPatch());
        ...
        registerTransformer(new GameEntityManagerChunkDirtyPatch());
